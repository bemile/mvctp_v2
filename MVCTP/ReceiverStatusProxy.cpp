...
void ReceiverStatusProxy::ConfigureEnvironment() {
	...
	system("sudo sysctl -w net.ipv4.udp_mem=\"18384 8388608 36777216\""); // 16777216
	system("sudo sysctl -w net.core.rmem_default=\"64777216\""); //8388608
	system("sudo sysctl -w net.core.rmem_max=\"128777216\""); // 16777216
